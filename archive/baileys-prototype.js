/**
 * ARCHIVED — DO NOT IMPORT OR EXECUTE FROM PRODUCTION.
 *
 * Former Baileys / unofficial WhatsApp Web prototype preserved for reference
 * during Security Phase 1. The live server (index.js) must never require this file.
 *
 * Status: DISABLED. WhatsApp automation via Baileys is turned off.
 * Next: replace with an official messaging provider in a later phase.
 *
 * Original snapshot of index.js before Security Phase 1.
 */
